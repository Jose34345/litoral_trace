...
| P2-01 Shadow-vs-Canonical benchmark | `tests/lacey_benchmark/test_shadow_canonical_diff.py` + `benchmarks/lacey/v2/*.json` | general CI pytest; no PostgreSQL gate required unless runtime/persistence code is later touched |

...
def evaluate_special_composite(inputs: SpecialCompositeInput) -> RuleAssessment:
    ...
    if inputs.thin_solid_plies_or_layers is TriState.YES:
        return _assessment(
            ...
            explanation="Thin plies or layers of solid wood do not use the SPECIAL / COMPOSITE declaration pathway.",
        )
    if inputs.species_determinable_after_due_care is TriState.YES:
        return _assessment(
            ...
            explanation="A scientific name is determinable from the supported evidence. The SPECIAL / COMPOSITE alternative is not applicable.",
        )
    if (
        ...
        return _assessment(
            ...
            explanation="The supplied construction facts do not identify a SPECIAL / COMPOSITE case.",
        )

...
def test_runtime_sessions_do_not_expire_orm_state_after_commit(monkeypatch):
    """Tenant RLS context is transaction-local; commit must not trigger an implicit refresh."""
